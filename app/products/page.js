...
//   return (
//     <>
//       <section className="flex items-center justify-center px-6 md:px-20 py-24 text-center">
...
//       <section className="flex flex-col items-center justify-center px-6 md:px-20 py-24 text-center">
//         <h2 className="text-white text-[32px] font-semibold">Trending</h2>
